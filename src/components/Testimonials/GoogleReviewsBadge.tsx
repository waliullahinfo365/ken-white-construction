 ...
 * Displays the overall Google rating with the Google logo.
 * Shows aggregate rating and total review count.
 */
...
export const GoogleReviewsBadge: React.FC = () => {
  return (
    <div className="flex flex-col items-center justify-center p-8 bg-white rounded-2xl shadow-lg">
      ...
      {/* Reviews label */}
      <p className="text-gray-600 text-lg font-medium mb-3">Reviews</p>
      ...
      {/* Review count */}
      <p className="text-gray-500 text-sm">Based on 150+ reviews</p>
    </div>
  );
};
